...
# WARNING: Ensure imports from `home_security` comes after this line
from home_security import app, settings, db  # noqa
from home_security.cli import create_user, cli  # noqa
